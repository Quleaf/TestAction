...
ENV PATH="/usr/local/cuda/bin:/usr/local/mpi/bin:/usr/local/ucx/bin: /usr/local/nvidia/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
ENV CPATH="/usr/include:/usr/local/mpi/include:/usr/local/ucx/include"
ENV LD_LIBRARY_PATH="/usr/local/mpi/lib:/usr/local/nvidia/lib:/opt/cuquantum/lib:/usr/local/nvidia/lib64"
