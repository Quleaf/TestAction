...
ENV PATH="/usr/local/cuda/bin:/usr/local/mpi/bin:/usr/local/ucx/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
ENV CPATH="/usr/include:/usr/local/mpi/include"
ENV LD_LIBRARY_PATH="/usr/local/mpi/lib:/opt/cuquantum/lib"
...
ENV CPATH=/usr/local/cuda-12.6/include:${HPCX_HCOLL_DIR}/include:${HPCX_SHARP_DIR}/include:${HPCX_UCX_DIR}/include:${HPCX_UCC_DIR}/include:${HPCX_MPI_DIR}/include:$CPATH
...
#    echo 'export MPI_PATH=/usr/local/mpi' >> /opt/cuquantum-source/cuquantum-env/activate_cuquantum.sh && \
#   for cutensornet samples require MPI_ROOT   
#    echo 'export MPI_ROOT=/usr/local/mpi' >> /opt/cuquantum-source/cuquantum-env/activate_cuquantum.sh && \
